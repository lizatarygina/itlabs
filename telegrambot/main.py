...
bot = telebot.TeleBot('5066095396:AAHpSM3KZ3JE29TrsZ-4dWYXTWkTiTleD4I')

conn = psycopg2.connect(database="telebot", user="postgres", password="1234", host="localhost", port="5432")
cursor = conn.cursor()
